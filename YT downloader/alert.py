...
"border-radius: 7px;")
        ...
        self.label_2.setGeometry(QRect(60, 10, 211, 21))
        font1 = QFont()
        ...
        self.label_3.setGeometry(QRect(10, 50, 261, 21))
